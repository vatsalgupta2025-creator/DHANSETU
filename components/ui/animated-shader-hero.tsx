...
const Hero: React.FC<HeroProps> = ({
    ...
    return (
        ...
        .hero-animation-delay-600 {
          animation-delay: 0.6s;
        }
        
        .hero-animation-delay-800 {
      ...
      `}</style>
            ...
            <div className="absolute inset-0 z-10 flex flex-col items-center justify-center text-white">
                {/* Trust Badge */}
                {trustBadge && (
                    <div className="mb-8 hero-animate-fade-in-down">
                ...
                <div className="text-center space-y-6 max-w-5xl mx-auto px-4">
                    ...
                    <div className="space-y-2">
                        <h1 className="text-5xl md:text-7xl lg:text-8xl font-bold bg-gradient-to-r from-orange-300 via-yellow-400 to-amber-300 bg-clip-text text-transparent hero-animate-fade-in-up hero-animation-delay-200">
                            {headline.line1}
                        </h1>
                        <h1 className="text-5xl md:text-7xl lg:text-8xl font-bold bg-gradient-to-r from-yellow-300 via-orange-400 to-red-400 bg-clip-text text-transparent hero-animate-fade-in-up hero-animation-delay-400">
                            {headline.line2}
                        </h1>
                    </div>

                    {/* Subtitle with Animation */}
                    <div className="max-w-3xl mx-auto hero-animate-fade-in-up hero-animation-delay-600">
                    ...
                    {buttons && (
                        <div className="flex flex-col sm:flex-row gap-4 justify-center mt-10 hero-animate-fade-in-up hero-animation-delay-800">
                            {buttons.primary && (
                                <button
...
// Also export the hook for reuse
export { useShaderBackground, defaultShaderSource };
